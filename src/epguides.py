...
class Show(object):	
	...
	def check_url(self):
		try:
			urllib.urlopen(HeadRequest(self.showurl))
...
def find_or_add(showname):
	...
	if show:
		show._parse_internal()

	return show

if __name__ == '__main__':
	print find_or_add('Breaking Bad')
	...
	try:
		...
		options.name = 'NCIS'
		#options.dshowname = 'NCIS'
		#options.showname = 'NCIS'
